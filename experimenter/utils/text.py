...
class clean_text:
    ...
    @classmethod
    def __call__(self, input_text: str = None, list_input=False):
        ...
        if input_text is None:
            return None
        if list_input:
            return [re.sub(self.remove, "", t.strip()) for t in input_text]
...
class Tokenizer:
    ...
    def detokenize(self, tokens: List[str], list_input=False):
        ...
        if list_input:
            res = []
            for inp in tokens:
                res.append(self.sep.join([t for t in inp]))
            return res
...
class Encoder:
    ...
    def _encode_one(self, input_data: str, vocab: dict = None, update_vocab: bool = None, no_special_chars: bool = None) -> Union[List[List[int]], dict]:
    ...
    def _encode_list(self, input_data: List[str],  vocab: dict = None, update_vocab: bool = None, no_special_chars: bool = None) -> Union[List[List[int]], dict]:
